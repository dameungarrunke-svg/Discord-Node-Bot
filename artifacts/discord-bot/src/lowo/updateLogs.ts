...
export const UPDATE_LOGS: UpdateEntry[] = [
  {
    ...
    highlights: [
      ...
      "**🌑 NEW AREA — THE INFINITE VOID** *(Stage 6)* — **101 brand-new pets!**",
      "  • Unlock by completing **100% of every prior area's dex** *(Forest → Unknown Void)*.",
      "  • Filled with **101 unique boss-class pets** themed around Void-Dragons, Glitch-Spiders, Reality-Eaters, Shadow-Knights & Abyssal-Serpents.",
      "  • Every spawn is **EPIC rarity or higher** — Epic → Legendary → Mythic → Ethereal → Inferno → Cosmic → Void → 3 hidden **SECRETS** *(🪬 Divine Dihraga, 🜏 Void Sovereign, 🌀 The Architect's Mistake)*.",
