...
async function selfEmote(message: Message, label: string, emoji: string, gifKey: string): Promise<void> {
...
export const cmdLewd = (m: Message) => selfEmote(m, "feels lewd", "😳", "blush");
