...
- `/tournament` creates a premium Last Stand / TSB tournament announcement with role ping, bracket details, participant counter, persistent participant tracking, and Join/Leave/View Participants buttons. Tournament data is stored at `artifacts/discord-bot/data/tournaments.json`.
